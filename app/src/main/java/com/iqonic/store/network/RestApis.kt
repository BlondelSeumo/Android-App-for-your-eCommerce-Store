...
interface RestApis {
    ...
    fun listAllCategory(@Query("parent") parent: Int): Call<ArrayList<Category>>

    @GET("wc/v3/products")
    fun listSingleCategory(@Query("category") categories: Int): Call<ArrayList<StoreProductModel>>

    @GET("wc/v3/products")
    fun getProducts(@Query("page") page: Int): Call<ArrayList<StoreProductModel>>
    ...
    fun getProductAttribute(): Call<ArrayList<StoreProductAttribute>>

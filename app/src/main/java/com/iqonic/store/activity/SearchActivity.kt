...
class SearchActivity : AppBaseActivity() {
    ...
    var totalPages=0;
    private val mProductAdapter =BaseAdapter<StoreProductModel>(R.layout.item_viewproductgrid, onBind = { view, model, position->
    ...
    private fun openFilterBottomSheet() {
        val filterDialog = BottomSheetDialog(this); filterDialog.setContentView(R.layout.layout_filter)
        ...
        val brandAdapter =
            BaseAdapter<Term>(R.layout.item_filter_brand, onBind = { view, model, position ->
                ...
                if (model.isParent) {
                    ...
                    if (model.isSelected) {
                        view.tvBrandName.setTextColor(color(R.color.PrimaryHeadingColor))
                        view.ivSelect.setImageResource(R.drawable.ic_check)
                        view.ivSelect.setColorFilter(color(R.color.PrimaryHeadingColor))
                        ...
                        view.tvBrandName.setTextColor(color(R.color.textColorSecondary))

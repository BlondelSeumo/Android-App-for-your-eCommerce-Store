...
class WebViewActivity : AppBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        BroadcastReceiverExt(this@WebViewActivity) { onAction(Constants.AppBroadcasts.CART_COUNT_CHANGE) {
        } }
    }
    ...
    private fun configureWebClient() {
        mWebViewClient = object : WebViewClient() {
            ...
            override fun onReceivedError(
                ...
                Toast.makeText(this@WebViewActivity, error.toString(), Toast.LENGTH_LONG)
                    .show()
                finish()
            }
            ...
            override fun onReceivedHttpError(
                ...
                Toast.makeText(this@WebViewActivity, "onReceivedHttpError", Toast.LENGTH_LONG)
                    .show()
                finish()
            }

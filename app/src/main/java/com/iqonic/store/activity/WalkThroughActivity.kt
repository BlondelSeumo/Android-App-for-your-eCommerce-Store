...
import com.iqonic.store.utils.Constants.SharedPref.SHOW_SWIPE
import com.iqonic.store.utils.extensions.getSharedPrefInstance
import com.iqonic.store.utils.extensions.launchActivity
import com.iqonic.store.utils.extensions.makeTransaprant
import com.iqonic.store.utils.extensions.onClick
...
class WalkThroughActivity : AppBaseActivity() {
    ...
    internal inner class WalkAdapter : PagerAdapter() {
        ...
        private var mSubHeading = arrayOf(
            getString(R.string.lbl_dummy_text),
            getString(R.string.lbl_dummy_text),
            getString(R.string.lbl_dummy_text)
        )
